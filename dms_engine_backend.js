...
// ===============================================
// HUMAN-CENTERED AI DMS ENGINE (Frontend + Backend Logging)
...
function sendToBackend(ear, headDir, fatigue) {

    // Log every 30 frames (~1 sec approx)
    if (logCounter % 30 === 0) {
        fetch("/log", {
            method: "POST",
...
async function detectLoop() {
    ...
    if (predictions.length > 0) {
        ...
        // Send to backend CSV logger
        sendToBackend(ear, headDir, fatigue);
